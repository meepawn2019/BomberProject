...
public class flame extends item{
    private Image img_1 = new ImageIcon(getClass().getResource("/Character/flame_1.png")).getImage();
    private Image img_2 = new ImageIcon(getClass().getResource("/Character/flame_2.png")).getImage();
    private Image img_3 = new ImageIcon(getClass().getResource("/Character/flame_3.png")).getImage();
